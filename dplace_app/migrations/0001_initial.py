# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2017-09-07 07:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('region_nam', models.CharField(db_index=True, max_length=254)),
                ('continent', models.CharField(db_index=True, max_length=254)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('pages', models.CharField(default='', max_length=100)),
            ],
        ),
        migrations.CreateModel(
            name='Society',
            fields=[
                ...
                ('original_name', models.CharField(default=None, max_length=500, null=True, verbose_name='ORIG_name')),
                ...
                ('hraf_link', models.CharField(default=None, max_length=500, null=True, verbose_name='HRAF')),
                ('chirila_link', models.CharField(default=None, max_length=500, null=True, verbose_name='CHIRILA')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(db_index=True, default='Unknown', max_length=500)),
                ('type', models.CharField(max_length=13)),
        ...
        migrations.AddField(
            ...
            name='source',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='references', to='dplace_app.Source'),
        ),
        migrations.AddField(
            model_name='reference',
            name='value',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='references', to='dplace_app.Value'),
        ),
        migrations.AddField(
